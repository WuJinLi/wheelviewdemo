...
import com.wheelviewdemo.wujinli.wheelviewdemo.view.adapter.WheelAdapter;
import com.wheelviewdemo.wujinli.wheelviewdemo.view.listener.OnItemSelectedListener;
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.drawText(contentText, drawCenterContentStart, maxTextHeight -
                            CENTERCONTENTOFFSET, paintCenterText);
                    canvas.restore();
